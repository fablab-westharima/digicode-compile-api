...
// ============================================
// PID gain は SET_PID:name,kp,ki,kd command で BLE GATT NUS 経由 runtime 上書き、 user code が getPidGain で読出。
...
void processCommand(String command) {
  ...
  // SET_PID line command (BlePidTransport から BLE GATT NUS 経由送信、 USB template と同 spec)
